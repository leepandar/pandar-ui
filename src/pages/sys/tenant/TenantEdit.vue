...
const defaultTenantDatasource = {
    datasourceName: null,
    datasourceUrl: 'jdbc:mysql://localhost:3306/pandar?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai&allowMultiQueries=true&useAffectedRows=true&rewriteBatchedStatements=true',
    username: null,
    password: null
}
//表单
